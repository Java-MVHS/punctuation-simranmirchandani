/* Simran Mirchandani
 * 12/11/24
 * This program will take some text, read it and print all the words with punctuation
 * in it.This program will not use any field variables but there will be a variable for the text.
 *
 * main()
 * call searchIt
 *
...
public class Punctuation
{
    ...
    public void searchIt()
    {
        String str =  "Blood, Sweat, and Tears by Winston Churchill "
                +" May 13, 1940 " +" Mr. Speaker: " + " On Friday evening last I received His Majesty’s commission to form a new " + " Administration. It was the evident wish and will of Parliament and the "
    ...
    public static String getPunctuationWords(String str)
    {
    ...
    public static boolean checkForPunctuation(String word)
    {
        ...
        {
            if(word.indexOf(punctuation.charAt(i)) != -1)
            {
                return true;
            }
        }
    ...
    public static void printWords(String words)
    {
        if( words.length() > 0)
        {
            System.out.println("Words with punctuation:" + words);
        }
        else
        {
            System.out.println("There are no words with punctuation.");
        }
    }
}
